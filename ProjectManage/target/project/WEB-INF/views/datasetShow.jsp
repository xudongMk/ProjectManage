...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav">
        ...
        <li calss="active"><a href="dataSetshow">数据集</a></li>
   ...
   <table class="table table-hover" id="dataset_show"></table>
  </div>
					...
					success : function(data) {
		     		   ...
		     		   var str = "<tr><th>名称</th><th>简介</th><th>发布人</th><th>发布单位</th>	<th>发布时间</th></tr><tr>"
		     			for (var i = 0;i <data.length;i++){
		     				str = str + "<td>" + data[0].dataset_name 
		                    + "</td><td>" + data[0].dataset_introduction 
		                    + "</td><td>" + "som" 
		                    + "</td><td>" + "HFUT" 
