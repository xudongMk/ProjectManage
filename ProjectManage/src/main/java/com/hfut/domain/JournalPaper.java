...
public class JournalPaper {
	...
	public JournalPaper(String paper_name, String paper_introduction,
			String paper_author, String paper_publishers, String paper_volunmn,
			String paper_date, String paper_type, String paper_status,
			String paper_link, String username, String publish_time,int special,String img_id) {
		this.paper_name = paper_name;
		this.paper_introduction = paper_introduction;
		this.paper_author = paper_author;
		this.paper_publishers = paper_publishers;
		this.paper_volunmn = paper_volunmn;
	...
	public String getPaper_volunmn() {
		return paper_volunmn;
	}
	public void setPaper_volunmn(String paper_volunmn) {
		this.paper_volunmn = paper_volunmn;
	}
