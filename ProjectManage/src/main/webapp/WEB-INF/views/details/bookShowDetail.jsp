		...
		<div class="main">
			<div class="main_box">
				<div class="logo"></div>
                 ...
                 <div class="address">
					<a href=${ctx }>首页</a><a>：</a><a href="${ctx }/achievementshow">项目成果</a><a>&gt;</a><a href="${ctx }/bookshow/1">学术论著</a>
				</div>
				<div class="list_main">
		<div class="col-md-10">
			<div class="title">
			...
			<div class="info">
				<p>
					<strong><span>论著作者：</span></strong> <span>${conf.book_author}</span>
				</p>
				<p>
					<strong><span>出版时间：</span></strong> <span>${conf.book_time}</span>
				</p>
				<p>
					<strong><span>出版社：</span></strong> <span>${conf.book_publish}</span>
				</p>
			</div>

			<div class="abstract">
				<strong><span>论著简介：</span></strong>
				<p>${conf.book_introduction}</p>
			</div>
		</div>
	</div>
	</div>
