  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="meetingshow">参加会议</a></li>
   ...
   <table class="table table-hover" id="meeting_show"></table>
					...
					success : function(data) {
		     		   ...
		     		   var str = "<tr><th>名称</th><th>简介</th><th>发布人</th><th>发布单位</th>	<th>发布时间</th></tr><tr>"
		     			for (var i = 0;i <data.length;i++){
		     				str = str + "<td>" + data[0].meeting_name 
		                    + "</td><td>" + data[0].meeting_location 
		                    + "</td><td>" + "som" 
		                    + "</td><td>" + "HFUT" 
