...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav">
        <li class="active"><a href="projectshow">项目交流</a></li>
    ...
    <table class="table table-hover" id="project_show">
             ...
             success : function(data) {
     		   ...
     		   var str = "<tr><th>名称</th><th>简介</th><th>发布人</th><th>发布单位</th>	<th>发布时间</th></tr><tr>"
     			for (var i = 0;i <data.length;i++){
     				str = str + "<td>" + data[0].seminar_title 
                    + "</td><td>" + data[0].seminar_content 
                    + "</td><td>" + "som" 
                    + "</td><td>" + "HFUT" 
