		...
		<div class="main">
			<div class="main_box">
				<div class="logo"></div>
                 ...
                 <div class="address">
					<a href=${ctx }>首页</a><a>：</a><a href="${ctx }/achievementshow">项目成果</a><a>&gt;</a><a href="${ctx }/patentshow/1">专利</a>
				</div>
				<div class="list_main">
		<div class="col-md-10">
			<div class="title">
				<p>${conf.patent_name}</p>
			</div>
			<div class="post">
				<p>
			...
			<div class="info">
				<p>
					<strong><span>专利作者：</span></strong> <span>${conf.patent_author}</span>
				</p>
				<p>
					<strong><span>专利状态：</span></strong> <span>${conf.patent_status}</span>
				</p>
				<p>
					<strong><span>发表时间：</span></strong> <span>${conf.patent_date}</span>
				</p>
			   <p>
					<strong><span>相关链接：</span></strong> <span>${conf.patent_link}</span>
				</p>
				<p>
			</div>

			<div class="abstract">
				<strong><span>专利简介：</span></strong>
				<p>${conf.patent_introduction}</p>
			</div>
		</div>
	</div>
</div>
