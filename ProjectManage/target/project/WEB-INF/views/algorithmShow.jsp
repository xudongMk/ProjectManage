  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     <ul class="nav navbar-nav">
		...
		<li  class="active"><a href="algorithmshow">算法</a></li>
		<li><a href="achievementshow">成果展示</a></li>      
      </ul>
    ...
    <table class="table table-hover" id="algorithm_show"></table>
					...
					success : function(data) {
		     		   ...
		     		   var str = "<tr><th>名称</th><th>简介</th><th>发布人</th><th>发布单位</th>	<th>发布时间</th></tr><tr>"
		     			for (var i = 0;i <data.length;i++){
		     				str = str + "<td>" + data[0].algorithm_title 
		                    + "</td><td>" + data[0].algorithm_introduction 
		                    + "</td><td>" + "som" 
		                    + "</td><td>" + "HFUT" 
		                    + "</td><td>" + data[0].publish_time 
		                    + "</td>";
		                    str = str + "</tr>";
		     			}   			
		     			
		              $("#algorithm_show").html(str);
		     		},
					error : function() {
						alert("请求出错！");
					}
