     ...
     <%@ include file="../top.jsp"%>
		<div class="main">
			<div class="main_box">
				<div class="logo"></div>
                 ...
                 <div class="address">
					<a href=${ctx }>首页</a><a>：</a><a href="${ctx }/achievementshow">项目成果</a><a>&gt;</a><a href="${ctx }/conferencepapershow/1">会议论文</a>
				</div>
				<div class="list_main">
		...
		<div class="col-md-10">
			...
			<div class="info">
				...
				<p>
					<strong><span>会议名称：</span></strong> <span>${conf.paper_publishers}</span>
				</p>
				<p>
