  ...
  <body>
     ...
     <%@ include file="top.jsp"%>
		<div class="main">
	      ...
	      <div class="address">
					<a href=${ctx }>首页</a><a>：</a><a href="javascript:void(0);">算法共享</a>
				</div>
				<div class="list_main">
					<!-- hot 开始 -->
					<div class="hot">
						...
						<div class="hot_content">
							<div class="hot_content_box">
								<div class="hot_content_box_title">
									<img src="${ctx }/resources/img/hot_list_ico.png" />算法类型
								</div>
								<div class="hot_content_box_content">
									<ul>
										<li><a href="${ctx }/algorithmshow">全部</a></li>
									</ul>
								</div>
							</div>
					...
					<div class="list_pic_con">
						...
						<div class="list_pic_con_content">
							...
							<p class="title"><a href="${ctx }/details/algorithmshow/${list.algorithm_id}">
							${list.algorithm_name}</a></p>
							<p class="time">发布时间：${list.publish_time}</p>
							<p class="con">${list.algorithm_introduction}</p>							
							</li>
						  </c:forEach>									
